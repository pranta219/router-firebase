            ...
            <div class="w-full max-w-xs">
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="mb-6">
                        ...
                        <input class="shadow appearance-none border border-red-500 rounded py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="******************" />
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button class="inline-block bg-blue-400 align-baseline font-bold text-sm text-white-500
                        py-2 px-4 rounded hover:text-blue-800" href="">
                            Google Sing In
                        </button>
                    </div>
                </form>
